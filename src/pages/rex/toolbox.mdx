...
<b>⚠️ Be careful!</b> It might be possible to break the REX events viewer with importing some bad data.
If you find that the events page isn't working, you can import <code>[]</code> to clear your bookmarks.
</div>
